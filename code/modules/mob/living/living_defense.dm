...
/mob/living/proc/damage_through_armor(damage = 0, damagetype = BRUTE, def_zone = null, attack_flag = ARMOR_MELEE, armour_pen = 0, used_weapon = null, sharp = FALSE, edge = FALSE)
...
/mob/living/proc/embed(obj/item/O, def_zone=null)
	if(ismob(O.loc))
